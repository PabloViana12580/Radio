...
public class GUI extends Carro{
    ...
    public static void main(String[] args) {
        ...
        JLabel emisora = new JLabel(decimales.format(grupo.emisora)+" "+verificador(grupo.onda));
        ...
        ActionListener listener = new ActionListener(){
            public void actionPerformed( ActionEvent e) {
                ...
                if(opciones[opcion]=="Reproducir"){
                    ...
                    if(opciones[opcion]=="Guardar"){
                        grupo.guardar(Integer.parseInt(((JButton) e.getSource()).getName()));
                    }else{
                        //se sale rel recuadro
                    }
                }   
                emisora.setText(decimales.format(grupo.emisora)+" "+verificador(grupo.onda));       
            }
        };
